  ...
  export const workExperiences = [
    {
      ...
      title: " Language - C++ , Javascript || Technologies Tools - Dynamic HTML, Tailwind, Typescript, React, NextJs, NodeJs, ThreeJs,  Express,MongoDB, Docker, Postgress, Prisma, Git/Github, Linux",
      icon: '/assets/sameeppng.png',
      animation: 'salute',
    },
    {
      id: 1,
      name: 'The Coders Trade',
      pos: 'Building a platform where you can learn about trading and see realtime charts with the filters of your choice ',
